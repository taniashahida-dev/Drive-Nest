      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-10 lg:grid-cols-2">
          ...
          <div className="overflow-hidden rounded-3xl border border-[#0E8388]/20 bg-[#2E4F4F] shadow-2xl p-4">
            ...
            <h1 className="text-4xl font-bold md:text-5xl my-5">
              {car.name}
            </h1>
 {/* Type */}
   {/* Description */}
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-8 flex items-end gap-2">
              ...
              <span className="mb-1 text-[#CBE4DE]/60">
                / day
              </span>
            </div>
            ...
            <div className="mt-10 grid grid-cols-2 gap-5">
              <div className="rounded-2xl border border-[#0E8388]/10 bg-[#2E4F4F] p-5">
                ...
                <p className="text-sm text-[#CBE4DE]/50">
                  Car Type
                </p>
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <button className="rounded-xl bg-[#0E8388] px-8 py-4 font-semibold text-white transition-all duration-300 hover:bg-[#0c7478]">
                Book Now
              </button>
